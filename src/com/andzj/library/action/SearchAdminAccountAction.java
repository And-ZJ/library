...
public class SearchAdminAccountAction extends ActionSupport{
	...
	public String execute() {
		try 
		{
			...
			{
				if (administratorService.findAllAdminAccount())
				{
					return null;
				}
			}
			else if ("account".equals(searchMode))
			{
				...
				if (administratorService.searchAdminAccount(accountName))
				{
					return null;
				}
			}
